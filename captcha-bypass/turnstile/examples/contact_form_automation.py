"""Automate ERPSKRIP contact-form filling and optional submission.

Default mode fills the form and solves/waits for Turnstile, but does not submit.
Use --submit when you intentionally want to click "Kirim Pesan".
"""
...
DEFAULT_URL = "https://erpskrip.id/kontak"
DEFAULT_ALLOWED_HOSTS = {"erpskrip.id", "www.erpskrip.id"}
