...
def build_parser():
    p = argparse.ArgumentParser(
        prog="obfuscate.py",
        description="Obfuscate file HTML/CSS/JS/Python (murni-Python).",
    )
    ...
    p.add_argument("--type", "-t", choices=["auto", "html", "js", "css", "py"],
                   default="auto",
    ...
    p.add_argument("--no-verify", action="store_true",
                   help="Lewati verifikasi round-trip untuk mode HTML.")
    return p
